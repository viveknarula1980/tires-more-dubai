...
function TireGridItem({ t }: { t: any }) {
  ...
  return (
    <div className="group flex flex-col rounded-lg border border-border bg-card overflow-hidden hover:border-brand hover:shadow-lg transition-all">
      ...
      <button
        ...
        className="border-t border-border bg-navy text-navy-foreground py-3 text-sm font-semibold inline-flex items-center justify-center gap-2 hover:bg-brand transition-colors"
      >
